return {
  {
    ...
    keys = {
      ...
      { "<leader>Sw", function() require("spectre").open_visual() end,                            desc = "Spectre: Search current word",   mode = { "v" } },
      { "<leader>Sp", function() require("spectre").open_file_search({ select_word = true }) end, desc = "Spectre: Search on current file" },
    },
  },
}
