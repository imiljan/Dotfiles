    ...
    config = function()
      require("gitsigns").setup({
        ...
        on_attach = function(bufnr)
          ...
          vim.keymap.set("v", "<leader>hs", function() gs.stage_hunk({ vim.fn.line("."), vim.fn.line("v") }) end, { buffer = bufnr, desc = "HUNK: stage" })
          vim.keymap.set("n", "<leader>hr", gs.reset_hunk, { buffer = bufnr, desc = "HUNK: reset" })
          vim.keymap.set("v", "<leader>hr", function() gs.reset_hunk({ vim.fn.line("."), vim.fn.line("v") }) end, { buffer = bufnr, desc = "HUNK: reset" })
          ...
          vim.keymap.set("n", "<leader>hb", function() gs.blame_line({ full = true }) end, { buffer = bufnr, desc = "HUNK: blame line" })
          vim.keymap.set("n", "<leader>hd", gs.diffthis, { buffer = bufnr, desc = "HUNK: diff" })
          vim.keymap.set("n", "<leader>hD", function() gs.diffthis("~") end, { buffer = bufnr, desc = "HUNK: diff file" })

          vim.keymap.set("n", "<leader>htb", gs.toggle_current_line_blame, { buffer = bufnr, desc = "HUNK: toggle current line blame" })
