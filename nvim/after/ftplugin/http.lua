...
vim.keymap.set("n", "<leader>hp", kulala.from_curl, { noremap = true, silent = true, desc = "HTTP: Paste from CURL" })
...
vim.keymap.set("n", "<C-Up>", kulala.jump_prev, { noremap = true, silent = true, desc = "HTTP: Prev" })
vim.keymap.set("n", "<C-Down>", kulala.jump_next, { noremap = true, silent = true, desc = "HTTP: Next" })
